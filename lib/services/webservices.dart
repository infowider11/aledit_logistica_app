...
import 'package:aledit_logistica/widgets/showSnackbar.dart';
...
class Webservices {
  ...
  //       apiUrl: ApiUrls.getServerStatusUrl, request: {}, isGetMethod: true);
  //   if (jsonResponse['status'] == 1) {
  //     serverStatus = jsonResponse['data']['status'];
  //   } else {
  //     serverStatus = 0;
  //   }
  // }
